...
public class CategoryIndia extends AppCompatActivity {
    SearchView search;
...
//firebase_calling
        ...
        reference=database.getReference("India");
        ...
        new CountDownTimer(duration, 1000) {
            ...
            public void onTick(long l) {
                Toast.makeText(CategoryIndia.this,"Please wait! Connecting to the Firebase",Toast.LENGTH_SHORT).show();
            }
